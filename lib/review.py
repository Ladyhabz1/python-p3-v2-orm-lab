...
class Review:
    ...
    def employee_id(self, value):
        ...
        from employee import Employee  # ✅ Import inside method to avoid circular import
    ...
    def instance_from_db(cls, row):
        ...
        if review:
            review.id = row[0]  # ✅ Ensure ID is updated
            review.year = row[1]
    ...
    def delete(self):
        ...
        delete the dictionary entry, and reset the id attribute.
        """
        sql = """
